    ...
    return (
        <div className="w-full font-Lato flex items-center " >
            <nav className='md:flex lg:w-4/5 w-11/12 mx-auto md:justify-between md:items-center py-2 '>
                ...
                <div className={`${isOpen ? 'opacity-100 z-20' : 'opacity-0 -z-50'} md:z-20 w-full mt-1 md:mt-0 left-0 md:w-fit md:opacity-100 bg-slate-50 md:bg-transparent  absolute md:static md:flex flex-col md:flex-row items-center transition-all duration-500 `}>
                    <ul className='flex flex-col md:flex-row items-center'>
                        ...
                        <li className='mx-4 flex flex-col py-1'>
                            <div className="relative inline-block px-44 py-3 md:p-0">
                                ...
                                <div className={`${isProgram ? 'block' : 'hidden'} absolute z-20 w-56 py-2 mt-1 overflow-hidden bg-white rounded-md shadow-xl dark:bg-gray-800 px-1`}>
                                    <a href="/mhysaClass" className={`${props.address === '/mhysaClass' ? 'border-l-2' : ''} flex items-center p-3 text-sm text-gray-600 capitalize transition-colors duration-200 transform  hover:bg-gray-300 border-indigo-900`}>
                                    ...
                                    <a href="/mhysaSpeakers" className={`${props.address === '/mhysaSpeakers' ? 'border-l-2' : ''} flex items-center p-3 text-sm text-gray-600 capitalize transition-colors duration-200 transform  hover:bg-gray-300 border-indigo-900`}>
                                        <svg className="w-5 h-5 mx-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li className={`${props.address === '/aboutUs' ? 'border-b-2' : ''} mx-4 flex flex-col w-full text-center md:w-fit py-1 border-indigo-900`}>
                            <a  href="/aboutUs" className='text-blue-one text-sm px-20  py-3 md:p-0' >About Us</a>
                        </li>
                        <li className={`${props.address === '/contactUs' ? 'border-b-2' : ''} mx-4 flex flex-col  w-full text-center md:w-fit py-1 border-indigo-900`}>
                            <a  href="/contactUs" className='text-blue-one text-sm px-20  py-3 md:p-0' >Contact Us</a>
                        </li>
                        <li className={`${props.address === '/blog' ? 'border-b-2' : ''} mx-4 flex flex-col  w-full text-center md:w-fit py-1 border-indigo-900`}>
                        ...
                        props.data.email === '' ? 
                            (  
                                <div className="flex flex-row items-center relative lg:ml-32 2xl:ml-96 justify-center ">
                                    <a href="/sign-in" 
                                    className=" text-sm md:bg-white md:rounded-3xl sm:pl-7 py-1.5 md:border 
                                    md:border-blue-one md:text-blue-one md:pr-28  px-7"
                                    >Login</a>
                                    <a href="/sign-up" 
                                    className="text-sm md:bg-blue-one md:rounded-3xl px-7 py-1.5 md:border 
                            ...
                            (
                                <div className="relative py-3 md:p-0 lg:ml-24 2xl:ml-96 w-full md:w-fit ">
                                    <div className="w-fit mx-auto">
                                        <button
                                            onClick={() => setIsEmail(!isEmail)}
                                            className="relative md:bg-blue-one rounded-full z-10 flex items-center p-1 md:py-2 md:px-3 text-sm text-blue-one md:text-white font-semibold "
                                            type="submit"
                                        >
                                            ...
                                            <div className="relative">
                                                ...
                                                >
                                                    <path className={`${!isEmail ? "block" : "hidden"}`}
